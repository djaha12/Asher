        ...
        <div>
          <div class="card">
            ...
            <form id="st-form">
              ...
              <h4 style="margin:18px 0 10px">Старое золото в зачёт</h4>
              <label class="field"><span>Цена грамма лома 585-й пробы, сом</span>
                <input name="scrap_price_585" inputmode="decimal" placeholder="Например: 4000"
                  value="${ui.esc(s.scrap_price_585 || '')}"></label>
              <p class="form-hint">По этой цене касса оценивает старое золото, которое клиент сдаёт
                в зачёт покупки: вес × цена грамма. Другие пробы — пропорционально золоту в них:
                750-я дороже 585-й в 750/585 раза. Ориентир — учётная цена золота Нацбанка
                (nbkr.kg) за вычетом ваших расходов на переплавку. Продавец цену не меняет.
                Пустое поле — старое золото в зачёт не принимаем.</p>
