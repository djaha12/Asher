...
window.Pages.import = (() => {
  ...
  return {
    ...
    async render(el) {
      ...
      /*
       * Импорт идёт по шагам: файл, сопоставление колонок, отчёт. Чужое
       * изменение не должно выбрасывать владельца из середины на первый шаг
       * и стирать отчёт о том, что загрузилось, — здесь обновлять нечего.
       */
